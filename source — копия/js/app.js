    ...
    setup_listener = function () {
        ...
        function carousel(root) {
            ...
            navBut.on('click',function (e) {
                ...
                console.log(butInd);
                carnav.css('left',591-17*14*butInd+"px");
                rulernav.css('left',-6* itemsRuler*butInd+"px");
